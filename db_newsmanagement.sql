...
CREATE TABLE `account`  (
  ...
  `AccIsActive` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `category`  (
  ...
  `CatIsActive` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `subcategories`  (
  ...
  `CatID` int(11) NULL DEFAULT NULL,
  `SubCatIsActive` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `subscriber`  (
  ...
  CONSTRAINT `fk_subscriber_account` FOREIGN KEY (`AccID`) REFERENCES `account` (`AccID`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `fk_subscriber_account1` FOREIGN KEY (`Email`) REFERENCES `account` (`Username`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;
